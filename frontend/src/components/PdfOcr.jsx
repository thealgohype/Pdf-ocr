...
const PDFComparison = () => {
  ...
  return (
    <div className="flex flex-col items-center p-4 bg-gradient-to-r from-blue-400 to-teal-400">
      <h1 className="text-3xl font-bold mb-4 text-white">Extract OCR</h1>
      <div className="flex justify-between w-full max-w-7xl bg-white rounded-lg shadow-lg p-6">
        <div className="w-[48%]">
